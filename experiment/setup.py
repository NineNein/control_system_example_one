...
setup(
  name = 'experiment',         # How you named your package folder (MyLib)
  packages = ['experiment'],   # Chose the same as "name"
  ...
  url = 'https://github.sydney.edu.au/QCL/experiment',   # Provide either the link to your github or to your website
